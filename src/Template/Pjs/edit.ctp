...
<fieldset>
	...
	<div class="form-group">
		...
		<div class="col-lg-9">
			<input name="handphone" class="form-control number" id="Handphone" placeholder="No. Handphone" type="text" value="<?php echo $pjs['handphone']; ?>" required>
		</div>
	</div>
	<div class="form-group">
		<label for="Email" class="col-lg-3 control-label">Email</label>
		<div class="col-lg-9">
			<input name="email" class="form-control" id="Email" placeholder="Email" type="email" value="<?php echo $pjs['email']; ?>" required>
		</div>
	</div>
	<div class="form-group">
		<label for="KTP" class="col-lg-3 control-label">No. KTP</label>
		<div class="col-lg-9">
			<input name="ktp" class="form-control number" id="KTP" placeholder="No. KTP" type="text" value="<?php echo $pjs['ktp']; ?>" required>
		</div>
	</div>
	<div class="form-group">
