			...
			<div class="panel-body">
				...
				<div class="tab-content">
					<div id="Detail" class="tab-pane fade in active">
                        <?php echo $this->Form->create(null, ['url' => ['action' => 'updateContract', $this->request->query('id')], 'type' => 'file', 'data-parsley-validate']); ?>
                            <div class="row">
                                        ...
                                        <div class="panel-body">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" class="form-control input-sm" name="contract_id" value="<?php echo $contracts->id; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Tanggal Mulai</label>
                                                    <input type="text" id="TanggalMulaiKontrak" name="start_date" class="form-control input-sm date" value="<?php echo (!empty($contracts->start_date)) ? date('Y-m-d', strtotime($contracts->start_date)) : ''; ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Tanggal Berakhir</label>
                                                    <input type="text" id="TanggalBerakhirKontrak" name="end_date" class="form-control input-sm date" value="<?php echo (!empty($contracts->end_date)) ? date('Y-m-d', strtotime($contracts->end_date)) : ''; ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-body">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>PJ</label>
                                                    <select class="form-control input-sm" id="ContractPJ" name="contract_pj_id" disabled>
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-body">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Nama</label>
                                                    <select id="ContractPatient" name="contract_patient_id" class="form-control input-sm" disabled>
                                                        <option value="">--Silahkan Pilih--</option>
                                                    </select>
                                                </div>
                                            </div>
                                ...
                                <?php if ($this->request->session()->read('Auth.User.role_id') == 1): ?>
                                    <div class="col-md-12 col-sm-12 margin-bottom-30 text-right">
